/**
 * REMOVED: Return & Exchange Policy page
 * This page has been intentionally disabled as of 2026-06-20.
 * The original page content is preserved below in comments.
 * Visitors to /returns will be redirected to /about via next.config.js redirect.
 */
...
/*
 * ── ORIGINAL PAGE CONTENT (preserved for reference) ──────────────────────────
 *
 * 'use client';
 *
 ...
 *           <div className="space-y-2">
 *             <p className="text-xs text-neutral-600 leading-relaxed font-sans">
 *               Email: <a href="mailto:shopauthor.co@gmail.com" className="text-neutral-800 underline hover:opacity-85">shopauthor.co@gmail.com</a>
 *             </p>
 *             <p className="text-xs text-neutral-600 leading-relaxed font-sans">
 *               WhatsApp: <a href="https://wa.me/919076252241" target="_blank" rel="noopener noreferrer" className="text-neutral-800 underline hover:opacity-85">+91 9076252241</a>
 *             </p>
 *           </div>
